...
- 【現在の状況】
  - 副業フリーランスです。現在は副業案件のみ対応とさせていただいております。
- 【稼働条件】
  - 可動時間帯（平日: 19:00～23:00、土日祝: 09:00～23:00）
  - コロナ対策のためフルリモートのみ。
...
- [職務経歴](#職務経歴)
  - [2023年09月-至る現在 リーシング打診・マッチングシステムの新規開発](#2023年09月-至る現在-リーシング打診マッチングシステムの新規開発)
  - [2023年09月-至る現在 出店交渉履歴管理システムの保守・運用](#2023年09月-至る現在-出店交渉履歴管理システムの保守運用)
  - [2023年09月-至る現在 リーシング業務向けデータベース管理システムの保守・改修](#2023年09月-至る現在-リーシング業務向けデータベース管理システムの保守改修)
...
- 2023年09月頃からはリーダーとなり、マネージャー1名・開発者3名(自分含む, うち1名新入社員)の体制で、
  4製品の保守・運用、新規開発、改修などを行っています。
- 各製品の進捗・メンバーアサイン状況の把握が行えるよう、Redmineへの集約・チケットの正規化を進めています。
  最近(2024/03)やっとガントチャートが機能し始めました。引き続き整備を進め、効率化を図る予定です。




### 2023年09月-至る現在 リーシング打診・マッチングシステムの新規開発
...
### 2023年09月-至る現在 出店交渉履歴管理システムの保守・運用
...
### 2023年09月-至る現在 リーシング業務向けデータベース管理システムの保守・改修
